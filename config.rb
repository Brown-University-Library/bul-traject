...
# to_field "items_json_s" do |record, accumulator, context|
#   items = items_from_945(record)
#   if items.count > 0
#     # We have a few records with 800+ items that are too large for a string field.
#     # (e.g. https://search.library.brown.edu/catalog/b1801418).
#     #
#     # Index only the first 20 items, this will handle the very large majority
#     # of our records.
#     accumulator << items.take(20).to_json
#   end
# end